...
Image <- readJPEG("mlData/testImage.jpg")
...
Model_KM_6 <- kmeans(Image.DataFrame, 6)
...
# 기존 픽셀 정보를 6개의 군집데이터로 변경

KmeansCompressed.DF <- Model_KM_6$centers[Model_KM_6$cluster, ]

dim(KmeansCompressed.DF)





# DataFrame 구조를 Array 구조로 변환

KmeansCompressed <- array(KmeansCompressed.DF, dim(Image))
